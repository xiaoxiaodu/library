...
#===============================================================================
# library_dialogs : 获取library项目的dialog集合
#===============================================================================
def library_dialogs(request):
    items = []
    version = '1'
    ...
    return {'library_dialogs': '\n'.join(items)}


#===============================================================================
# library_views ： 获取library项目的view集合
#===============================================================================
def library_views(request):
    ...
    return {'library_views': '\n'.join(items)}


#===============================================================================
# library_component_templates ： 获取library项目的components集合
#===============================================================================
def library_component_templates(request):
    # print '*************************'
    items = []
    components_dir = os.path.join(settings.PROJECT_HOME, '../static/js/termite/component/library')
