...
TEMPLATE_CONTEXT_PROCESSORS = [
    ...
    'core.context_processors.library_views',
    'core.context_processors.library_dialogs',
    'core.context_processors.library_component_templates',
...
LIBRARY_WEB_DIALOG_DIRS = [
    ('static', '%s/../static/' % PROJECT_HOME),
]
LIBRARY_WEB_VIEW_DIRS = [
    ('static', '%s/../static/' % PROJECT_HOME),
]
LIBRARY_WEB_MODEL_DIRS = [
    ('static', '%s/../static/' % PROJECT_HOME),
]
