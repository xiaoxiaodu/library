/**
 * @class W.component.library.SwipeImageGroup
 * 
 */

ensureNS('W.component.library');
W.component.library.SwipeImageGroup = W.component.Component.extend({
	type: 'library.swipeimagegroup',
	shouldIgnoreSubComponent: true,
	dynamicComponentTypes: [
        {type: 'library.image', model: {index: 1, url: ''}}
    ],
